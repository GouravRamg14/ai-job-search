/** Labels for progress_stage index returned by GET /api/applications (demo pipeline). */
...
export const APPLICATION_STAGES = [
  ...
  { label: 'Interview', detail: 'Interview or technical round (demo placeholder).' },
  { label: 'Decision', detail: 'Offer or outcome pending (demo placeholder).' },
];
